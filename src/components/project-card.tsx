...
import {
  ...
  DropdownMenuItem,
  DropdownMenuTrigger,
  DropdownMenuSeparator, // Tambahan separator agar rapi
...
export function ProjectCard({
  ...
  // Fungsi untuk salin tautan ke clipboard
  const handleCopyLink = (e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
    navigator.clipboard.writeText(projectShareUrl);
    toast.success("Tautan profil developer berhasil disalin!");
  };
  ...
  return (
    <div className="glass card-lift group relative overflow-hidden rounded-2xl">
      <div className="relative aspect-[16/10] overflow-hidden bg-accent/40">
        ...
        {/* Tombol Hapus transparan yang lama di atas gambar sudah dihilangkan dari sini */}
      </div>
      ...
      <div className="p-4">
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          {/* Wrapper Tombol Aksi di Kanan Bawah */}
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" onClick={(e) => e.stopPropagation()}>
                ...
                {/* Opsi Hapus (Hanya muncul jika yang sedang login adalah pemilik postingan) */}
                {isOwner && (
                  <>
